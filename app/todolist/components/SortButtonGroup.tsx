    ...
    return (
        <div className="flex items-center">
            <span className="flex items-center w-full">
                <select className={`${styles.cusotmSortButton} w-1/2 pt-2 pr-2 pb-2 pl-4`} name="sortOrder" defaultValue={sortOptions.sortOrder} onChange={handleSortOptionChange}>
                    <option value="asc">昇順</option>
                    <option value="dsc">降順</option>
                </select>

                <select className={`${styles.cusotmSortButton} w-1/2 pt-2 pr-3 pb-2 pl-4`} name="sortBy" defaultValue={sortOptions.sortBy} onChange={handleSortOptionChange}>
